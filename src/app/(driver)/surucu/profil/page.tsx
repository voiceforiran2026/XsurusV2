...
import { Mail, Phone, Star, Car, ChevronRight } from 'lucide-react';
...
export default async function SurucuProfilPage() {
  ...
  return (
    <DriverShell>
      <div className="px-5 py-4 max-w-md mx-auto space-y-5">
        ...
        <Card className="p-5 bg-canvas text-white border-canvas">
